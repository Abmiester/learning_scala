...
$c_Lcalculator_Polynomial$.prototype.computeSolutions__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c, delta) {
  ...
  var rootDelta = new $c_Lcalculator_Signal().init___F0(expr$2);
  $m_Lcalculator_Signal$();
  var expr$3 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(delta$1$1, negB$1, twoA$1, rootDelta$1) {
    return (function() {
      if (($uD(delta$1$1.apply__O()) < 0)) {
        return $as_sci_Set($m_s_Predef$().Set$2.apply__sc_Seq__sc_GenTraversable($m_sci_Nil$()))
      } else {
        var array = [(($uD(negB$1.apply__O()) + $uD(rootDelta$1.apply__O())) / $uD(twoA$1.apply__O())), (($uD(negB$1.apply__O()) - $uD(rootDelta$1.apply__O())) / $uD(twoA$1.apply__O()))];
...
$c_Lcalculator_Polynomial$.prototype.computeDelta__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$1, b$1, c$1) {
    return (function() {
      var bval = $uD(b$1.apply__O());
      return ((bval * bval) - ((4 * $uD(a$1.apply__O())) * $uD(c$1.apply__O())))
    })
  })(a, b, c));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
...
/** @constructor */
function $c_Lcalculator_Calculator$$anonfun$computeValues$2() {
  $c_sr_AbstractFunction1.call(this);
...
/** @constructor */
function $h_Lcalculator_Calculator$$anonfun$computeValues$2() {
  /*<skip>*/
}
...
$c_Lcalculator_Calculator$$anonfun$computeValues$2.prototype.apply__T2__T2 = (function(x$1) {
  if ((x$1 !== null)) {
    var variable = $as_T(x$1.$$und1$f);
    var expression = $as_Lcalculator_Signal(x$1.$$und2$f);
    $m_Lcalculator_Signal$();
    var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, expression$1) {
      return (function() {
        return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($as_Lcalculator_Expr(expression$1.apply__O()), arg$outer.namedExpressions$1$f)
      })
    })(this, expression));
...
var $d_Lcalculator_Calculator$$anonfun$computeValues$2 = new $TypeData().initClass({
